...
import { c as Xt, g as Xl } from "./8337665f.js";
...
var ya = Rt.Symbol;
const te = ya;
var Jl = Object.prototype, va = Jl.hasOwnProperty, Aa = Jl.toString, pn = te ? te.toStringTag : void 0;
function Ea(n) {
...
function We(n) {
  return n == null ? n === void 0 ? La : xa : Zi && Zi in Object(n) ? Ea(n) : Ta(n);
}
function Ut(n) {
...
function no(n, t, e) {
  var r = n[t];
  (!(cc.call(n, t) && Cn(r, e)) || e === void 0 && !(t in n)) && Ei(n, t, e);
}
function In(n, t, e, r) {
  var s = !e;
  e || (e = {});
  for (var i = -1, o = t.length; ++i < o; ) {
    ...
    c === void 0 && (c = n[a]), s ? Ei(e, a, c) : no(e, a, c);
  }
  return e;
}
var Ji = Math.max;
...
function _r(n) {
  return n != null && ro(n.length) && !Ai(n);
}
function dc(n, t, e) {
  if (!ee(e))
    return !1;
...
var so = Object.prototype, yc = so.hasOwnProperty, vc = so.propertyIsEnumerable, Ac = Qi(function() {
  return arguments;
}()) ? Qi : function(n) {
...
var io = typeof exports == "object" && exports && !exports.nodeType && exports, tl = io && typeof module == "object" && module && !module.nodeType && module, Nc = tl && tl.exports === io, el = Nc ? Rt.Buffer : void 0, wc = el ? el.isBuffer : void 0, Tc = wc || Ec;
const Nn = Tc;
...
function Eu(n, t) {
  var e = this.__data__;
  return this.size += this.has(n) ? 0 : 1, e[n] = wn && t === void 0 ? Au : t, this;
}
function pe(n) {
...
var Eh = /\w*$/;
function Nh(n) {
  var t = new n.constructor(n.source, Eh.exec(n));
...
const Yh = Xh;
var Jh = 1, Qh = 2, tf = 4, vo = "[object Arguments]", ef = "[object Array]", nf = "[object Boolean]", rf = "[object Date]", sf = "[object Error]", Ao = "[object Function]", lf = "[object GeneratorFunction]", of = "[object Map]", af = "[object Number]", Eo = "[object Object]", cf = "[object RegExp]", uf = "[object Set]", hf = "[object String]", ff = "[object Symbol]", df = "[object WeakMap]", gf = "[object ArrayBuffer]", pf = "[object DataView]", mf = "[object Float32Array]", bf = "[object Float64Array]", yf = "[object Int8Array]", vf = "[object Int16Array]", Af = "[object Int32Array]", Ef = "[object Uint8Array]", Nf = "[object Uint8ClampedArray]", wf = "[object Uint16Array]", Tf = "[object Uint32Array]", j = {};
j[vo] = j[ef] = j[gf] = j[pf] = j[nf] = j[rf] = j[mf] = j[bf] = j[yf] = j[vf] = j[Af] = j[of] = j[af] = j[Eo] = j[cf] = j[uf] = j[hf] = j[ff] = j[Ef] = j[Nf] = j[wf] = j[Tf] = !0;
j[sf] = j[Ao] = j[df] = !1;
function vr(n, t, e, r, s, i) {
  ...
  var b = h ? c ? lh : Xs : c ? Rn : xi, A = d ? void 0 : b(n);
  return ic(A || n, function(v, y) {
    A && (y = v, v = n[y]), no(o, y, vr(v, t, e, y, n, i));
  }), o;
}
var xf = 1, Lf = 4;
function je(n) {
...
function No(n, t, e, r, s, i) {
  ...
  for (i.set(n, t), i.set(t, n); ++m < a; ) {
    var b = n[m], A = t[m];
    if (r)
      var v = o ? r(A, b, m, t, n, i) : r(b, A, m, n, t, i);
    if (v !== void 0) {
      if (v)
        continue;
      g = !1;
...
function Qf(n, t, e, r, s, i) {
  ...
  if (A && !v) {
    ...
    _ != L && "constructor" in n && "constructor" in t && !(typeof _ == "function" && _ instanceof _ && typeof L == "function" && L instanceof L) && (A = !1);
  }
...
function nd(n, t, e, r, s, i) {
  ...
  if (!(e & td)) {
    ...
    if (p || b) {
      var A = p ? n.value() : n, v = b ? t.value() : t;
      return i || (i = new Ot()), s(A, v, e, r, i);
    }
  }
...
const id = sd;
function ti(n, t, e) {
  (e !== void 0 && !Cn(n[t], e) || e === void 0 && !(t in n)) && Ei(n, t, e);
}
function ld(n) {
  return Ut(n) && _r(n);
}
...
function ad(n, t, e, r, s, i, o) {
  ...
  if (m) {
    ...
    d = c, g || p || b ? ge(a) ? d = a : ld(a) ? d = to(a) : p ? (m = !1, d = fo(c, !0)) : b ? (m = !1, d = bo(c, !0)) : d = [] : Fu(c) || Zs(c) ? (d = a, Zs(a) ? d = od(a) : (!ee(a) || Ai(a)) && (d = yo(c))) : m = !1;
  }
...
class ud extends Ct {
  ...
  remove(t) {
    Al(t, this.keyName).forEach((e) => {
      t.classList.remove(e);
    }), t.classList.length === 0 && t.removeAttribute("class");
  }
  value(t) {
    const e = (Al(t, this.keyName)[0] || "").slice(this.keyName.length + 1);
...
let bd = ke;
const qi = bd, Me = class ri extends At {
  static create(t) {
    return super.create(t);
  }
  static formats(t, e) {
...
let yd = Me;
const Ln = yd, si = class extends At {
  checkMerge() {
...
const ot = Ad, Ed = {
  ...
  optimize(t = [], e = {}) {
    ...
    const i = (c, h = !0) => {
      ...
      r.has(c.domNode) && (c instanceof At && c.children.forEach(o), r.delete(c.domNode), c.optimize(e));
    };
    let a = t;
    for (let c = 0; a.length > 0; c += 1) {
      ...
      for (a.forEach((h) => {
        ...
        d != null && (d.domNode === h.target && (h.type === "childList" ? (i(this.find(h.previousSibling, !1)), Array.from(h.addedNodes).forEach((m) => {
          ...
          i(g, !1), g instanceof At && g.children.forEach((p) => {
            i(p, !1);
          });
...
function Ld(n, t) {
  ...
  if (i !== -1)
    ...
    ], n.length > t.length && (e[0][0] = e[2][0] = lt), e;
  if (s.length === 1)
    return [
      [lt, n],
      [nt, t]
...
function Sd(n, t) {
  for (var e = n.length, r = t.length, s = Math.ceil((e + r) / 2), i = s, o = 2 * s, a = new Array(o), c = new Array(o), h = 0; h < o; h++)
    a[h] = -1, c[h] = -1;
  a[i + 1] = 0, c[i + 1] = 0;
  for (var d = e - r, m = d % 2 !== 0, g = 0, p = 0, b = 0, A = 0, v = 0; v < s; v++) {
...
function _d(n, t) {
  ...
  if (e.length < 4 || r.length * 2 < e.length)
    return null;
  function s(p, b, A) {
    for (var v = p.substring(A, A + Math.floor(p.length / 4)), y = -1, w = "", T, _, L, I; (y = b.indexOf(v, y + 1)) !== -1; ) {
      var B = Ii(
        p.substring(A),
        b.substring(y)
      ), U = Rr(
      ...
      w.length < U + B && (w = b.substring(y - U, y) + b.substring(y, y + B), T = p.substring(0, A - U), _ = p.substring(A + B), L = b.substring(0, y - U), I = b.substring(y + B));
    }
  ...
  for (t && Ri(n), Id(n), i = 1; i < n.length; ) {
    if (n[i - 1][0] == lt && n[i][0] == nt) {
      ...
      g >= p ? (g >= d.length / 2 || g >= m.length / 2) && (n.splice(i, 0, [
        ...
        0,
        m.length - p
      ), n[i + 1][0] = lt, n[i + 1][1] = d.substring(p), i++), i++;
    }
    i++;
  }
}
...
function Id(n) {
  function t(p, b) {
    if (!p || !b)
      return 6;
    var A = p.charAt(p.length - 1), v = b.charAt(0), y = A.match(Tl), w = v.match(Tl), T = y && A.match(xl), _ = w && v.match(xl), L = T && A.match(Ll), I = _ && v.match(Ll), B = L && p.match(qd), U = I && b.match(Cd);
    ...
    switch (n[e][0]) {
      ...
      case K:
        ...
        if (t) {
          if (c >= 0 && ko(n[c][1])) {
            ...
            if (n[c][1] = n[c][1].slice(
              ...
              n.splice(c, 1), e--;
              var d = c - 1;
              n[d] && n[d][0] === nt && (s++, o = n[d][1] + o, d--), n[d] && n[d][0] === lt && (r++, i = n[d][1] + i, d--), c = d;
            }
          }
          if (Ro(n[e][1])) {
        ...
        if (i.length > 0 || o.length > 0) {
          ...
          var m = s + r;
          i.length === 0 && o.length === 0 ? (n.splice(e - m, m), e = e - m) : i.length === 0 ? (n.splice(e - m, m, [nt, o]), e = e - m + 1) : o.length === 0 ? (n.splice(e - m, m, [lt, i]), e = e - m + 1) : (n.splice(
            e - m,
            m,
            [lt, i],
            [nt, o]
...
function kd(n, t, e) {
  ...
  if (r.length === 0 && (s === null || s.length === 0)) {
    ...
    t: {
      ...
      if (p !== h)
        break t;
      var b = Math.min(a, m), A = c.slice(0, b), v = g.slice(0, b);
      if (A !== v)
        break t;
  ...
  if (r.length > 0 && s && s.length === 0)
    t: {
      var A = n.slice(0, r.index), L = n.slice(r.index + r.length), b = A.length, _ = L.length;
      if (o < b + _)
        break t;
...
(function(n, t) {
  ...
  function zn(l, u) {
    for (var f = -1, E = u.length, R = l.length; ++f < E; )
      l[R + f] = u[f];
    return l;
  }
  function Ze(l, u, f, E) {
  ...
  function ts(l) {
    ...
    if (f < 0)
      return !1;
    var E = u.length - 1;
    return f == E ? u.pop() : Zr.call(u, f, 1), !0;
  }
  function es(l) {
    var u = this.__data__, f = qe(u, l);
  ...
  function ds(l, u) {
    ...
    if (f instanceof V) {
      ...
      f = this.__data__ = new X(E);
    }
    return f.set(l, u), this;
  }
  st.prototype.clear = cs, st.prototype.delete = us, st.prototype.get = hs, st.prototype.has = fs, st.prototype.set = ds;
  function Oe(l, u) {
    var f = fn(l) || Ie(l) ? Xe(l.length, String) : [], E = f.length, R = !!E;
    for (var C in l)
      (u || Tt.call(l, C)) && !(R && (C == "length" || Ss(C, E))) && f.push(C);
    return f;
  }
  function er(l, u, f) {
    var E = l[u];
    (!(Tt.call(l, u) && lr(E, f)) || f === void 0 && !(u in l)) && (l[u] = f);
  }
  function qe(l, u) {
  ...
  function cn(l, u, f, E, R, C, k) {
    var M;
    if (E && (M = C ? E(l, R, C, k) : E(l)), M !== void 0)
      return M;
    if (!St(l))
      return l;
    var z = fn(l);
    ...
    return Hn(G || l, function(J, W) {
      G && (W = J, J = l[W]), er(M, W, cn(J, u, f, E, W, l, k));
    }), M;
  }
  function gs(l) {
    return St(l) ? Xn(l) : {};
  ...
  function nr(l, u, f) {
    var E = u ? f(Kn(l), !0) : Kn(l);
    return Ze(E, Gr, new l.constructor());
  }
  function rr(l) {
  ...
  function vs(l, u, f) {
    var E = u ? f(Vn(l), !0) : Vn(l);
    return Ze(E, gt, new l.constructor());
  }
  function As(l) {
  ...
  function hn(l, u, f, E) {
    ...
    for (var R = -1, C = u.length; ++R < C; ) {
      var k = u[R], M = E ? E(f[k], l[k], k, f, l) : void 0;
  ...
  (Se && Dt(new Se(new ArrayBuffer(1))) != I || le && Dt(new le()) != g || pt && Dt(pt.resolve()) != A || _e && Dt(new _e()) != y || nn && Dt(new nn()) != _) && (Dt = function(l) {
    var u = Te.call(l), f = u == b ? l.constructor : void 0, E = f ? et(f) : void 0;
    if (E)
      switch (E) {
        case rn:
          return I;
  ...
  function Lt(l) {
    return typeof l.constructor == "function" && !sr(l) ? gs(at(l)) : {};
  }
  function Ls(l, u, f, E) {
    var R = l.constructor;
    switch (u) {
...
(function(n, t) {
  ...
  function Kn(l, u) {
    for (var f = -1, E = l == null ? 0 : l.length, R = 0, C = []; ++f < E; ) {
      var k = l[f];
      u(k, f, l) && (C[R++] = k);
    }
    return C;
  ...
  var Te = Array.prototype, Wr = Function.prototype, ie = Object.prototype, xe = gt["__core-js_shared__"], tn = Wr.toString, at = ie.hasOwnProperty, Xn = function() {
    var l = /[^.]+$/.exec(xe && xe.keys && xe.keys.IE_PROTO || "");
    return l ? "Symbol(src)_1." + l : "";
  }(), Yn = ie.toString, Zr = RegExp(
    "^" + tn.call(at).replace(zr, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ...
  function ns(l) {
    var u = this.__data__;
    return Vt ? u[l] !== void 0 : at.call(u, l);
  }
  function rs(l, u) {
    var f = this.__data__;
  ...
  function is(l) {
    ...
    if (f < 0)
      return !1;
    var E = u.length - 1;
    return f == E ? u.pop() : le.call(u, f, 1), --this.size, !0;
  }
  function ls(l) {
    var u = this.__data__, f = Ce(u, l);
    return f < 0 ? void 0 : u[f][1];
  ...
  function ds(l, u) {
    var f = mt(this, l), E = f.size;
    return f.set(l, u), this.size += f.size == E ? 0 : 1, this;
  }
  st.prototype.clear = cs, st.prototype.delete = us, st.prototype.get = hs, st.prototype.has = fs, st.prototype.set = ds;
  function Oe(l) {
    var u = -1, f = l == null ? 0 : l.length;
    for (this.__data__ = new st(); ++u < f; )
      this.add(l[u]);
  }
  function er(l) {
  ...
  function ys(l, u) {
    var f = Ie(l), E = !f && lr(l), R = !f && !E && Re(l), C = !f && !E && !R && cr(l), k = f || E || R || C, M = k ? Kr(l.length, String) : [], z = M.length;
    for (var $ in l)
      (u || at.call(l, $)) && !(k && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function rr(l, u, f, E, R) {
    return l === u ? !0 : l == null || u == null || !St(l) && !St(u) ? l !== l && u !== u : vs(l, u, f, E, rr, R);
  }
  function vs(l, u, f, E, R, C) {
    ...
    if (G && !Y)
      return C || (C = new xt()), k || cr(l) ? hn(l, u, f, E, R, C) : ws(l, u, z, f, E, R, C);
    if (!(f & s)) {
      var J = Y && at.call(l, "__wrapped__"), W = it && at.call(u, "__wrapped__");
      if (J || W) {
        var Wt = J ? l.value() : l, Pt = W ? u.value() : u;
        return C || (C = new xt()), R(Wt, Pt, f, E, C);
      }
    }
    return G ? (C || (C = new xt()), Ts(l, u, f, E, R, C)) : !1;
  }
  function As(l) {
    if (!ar(l) || _s(l))
      return !1;
  ...
  function hn(l, u, f, E, R, C) {
    ...
    if ($ && C.get(u))
      return $ == u;
    var Y = -1, it = !0, G = f & i ? new Oe() : void 0;
    for (C.set(l, u), C.set(u, l); ++Y < M; ) {
      var J = l[Y], W = u[Y];
      if (E)
        var Wt = k ? E(W, J, Y, u, l, C) : E(J, W, Y, l, u, C);
      if (Wt !== void 0) {
        if (Wt)
          continue;
        it = !1;
      ...
      if (G) {
        if (!Vn(u, function(Pt, he) {
          if (!we(G, he) && (J === Pt || R(J, Pt, f, E, C)))
            return G.push(he);
        })) {
          it = !1;
          break;
        }
      } else if (!(J === W || R(J, W, f, E, C))) {
        it = !1;
        break;
      }
    }
    return C.delete(l), C.delete(u), it;
  }
  function ws(l, u, f, E, R, C, k) {
    switch (f) {
      case se:
  ...
  function Ts(l, u, f, E, R, C) {
    var k = f & s, M = ue(l), z = M.length, $ = ue(u), Y = $.length;
    if (z != Y && !k)
      return !1;
    for (var it = z; it--; ) {
      var G = M[it];
      if (!(k ? G in u : at.call(u, G)))
        return !1;
    }
    var J = C.get(l);
    if (J && C.get(u))
    ...
    for (var Wt = k; ++it < z; ) {
      ...
      var Pt = l[G], he = u[G];
      if (E)
        var Ki = k ? E(he, Pt, G, u, l, C) : E(Pt, he, G, l, u, C);
      if (!(Ki === void 0 ? Pt === he || R(Pt, he, f, E, C) : Ki)) {
        W = !1;
        break;
      }
      Wt || (Wt = G == "constructor");
  ...
  function $t(l, u) {
    var f = Qe(l, u);
    return As(f) ? f : void 0;
  }
  function Dt(l) {
    var u = at.call(l, pt), f = l[pt];
    try {
      l[pt] = void 0;
      var E = !0;
    } catch (C) {
    ...
    var R = Yn.call(l);
    return E && (u ? l[pt] = f : delete l[pt]), R;
  }
  ...
  (rn && Lt(new rn(new ArrayBuffer(1))) != se || ae && Lt(new ae()) != A || sn && Lt(sn.resolve()) != T || ln && Lt(new ln()) != I || on && Lt(new on()) != Kt) && (Lt = function(l) {
    var u = ce(l), f = u == w ? l.constructor : void 0, E = f ? et(f) : "";
    if (E)
      switch (E) {
        case Qn:
          return se;
  ...
  var lr = nr(function() {
    ...
    return St(l) && at.call(l, "callee") && !Se.call(l, "callee");
  }, Ie = Array.isArray;
  function fn(l) {
...
(function(n, t) {
  ...
  class d {
    ...
    slice(g = 0, p = 1 / 0) {
      const b = [], A = new a.default(this.ops);
      let v = 0;
      for (; v < p && A.hasNext(); ) {
        let y;
        v < g ? y = A.next(g - v) : (y = A.next(p - v), b.push(y)), v += o.default.length(y);
      }
      return new d(b);
    }
    compose(g) {
      const p = new a.default(this.ops), b = new a.default(g.ops), A = [], v = b.peek();
      if (v != null && typeof v.retain == "number" && v.attributes == null) {
        let w = v.retain;
        for (; p.peekType() === "insert" && p.peekLength() <= w; )
          w -= p.peekLength(), A.push(p.next());
    ...
    diff(g, p) {
      ...
      }).join("")), A = new d(), v = e(b[0], b[1], p, !0), y = new a.default(this.ops), w = new a.default(g.ops);
      return v.forEach((T) => {
        let _ = T[1].length;
        for (; _ > 0; ) {
          let L = 0;
          switch (T[0]) {
            case e.INSERT:
              L = Math.min(w.peekLength(), _), A.push(w.next(L));
              break;
            case e.DELETE:
              L = Math.min(_, y.peekLength()), y.next(L), A.delete(L);
              break;
            case e.EQUAL:
              L = Math.min(y.peekLength(), w.peekLength(), _);
              const I = y.next(L), B = w.next(L);
              s(I.insert, B.insert) ? A.retain(L, i.default.diff(I.attributes, B.attributes)) : A.push(B).delete(L);
              break;
          }
          _ -= L;
        }
...
`) {
      ...
      for (; b.hasNext(); ) {
        ...
        if (T < 0)
          ...
          if (g(A, b.next(1).attributes || {}, v) === !1)
            return;
          v += 1, A = new d();
        }
      }
    ...
    invert(g) {
      const p = new d();
      return this.reduce((b, A) => {
        if (A.insert)
          p.delete(o.default.length(A));
        else {
          if (typeof A.retain == "number" && A.attributes == null)
            return p.retain(A.retain), b + A.retain;
          if (A.delete || typeof A.retain == "number") {
            const v = A.delete || A.retain;
            return g.slice(b, b + v).forEach((w) => {
              A.delete ? p.push(w) : A.retain && A.attributes && p.retain(o.default.length(w), i.default.invert(A.attributes, w.attributes));
            }), b + v;
          } else if (typeof A.retain == "object" && A.retain !== null) {
            const v = g.slice(b, b + 1), y = new a.default(v.ops).next(), [w, T, _] = h(A.retain, y.insert), L = d.getHandler(w);
            return p.retain({ [w]: L.invert(T, _) }, i.default.invert(A.attributes, y.attributes)), b + 1;
          }
        }
        return b;
      }, 0), p.chop();
    ...
    transform(g, p = !1) {
      ...
      const b = g, A = new a.default(this.ops), v = new a.default(b.ops), y = new d();
      for (; A.hasNext() || v.hasNext(); )
        if (A.peekType() === "insert" && (p || v.peekType() !== "insert"))
          y.retain(o.default.length(A.next()));
        else if (v.peekType() === "insert")
          y.push(v.next());
        else {
          const w = Math.min(A.peekLength(), v.peekLength()), T = A.next(w), _ = v.next(w);
          if (T.delete)
            continue;
          if (_.delete)
            y.push(_);
...
x(_t, "allowedChildren", [_t, wt, ot, Et]), // Lower index means deeper in the DOM tree, since not found (-1) is for embeds
x(_t, "order", [
  "cursor",
  "inline",
  // Must be lower
...
ft.scope = q.BLOCK_BLOT;
function $o(n) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return n.descendants(Q).reduce((e, r) => r.length() === 0 ? e : e.insert(r.value(), ut(r, {}, t)), new O()).insert(`
`, ut(n));
}
function ut(n) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0;
  return n == null || ("formats" in n && typeof n.formats == "function" && (t = H(H({}, t), n.formats()), e && delete t["code-token"]), n.parent == null || n.parent.statics.blotName === "scroll" || n.parent.statics.scope !== n.statics.scope) ? t : ut(n.parent, t, e);
}
const ct = class ct extends ot {
  ...
  constructor(t, e, r) {
    super(t, e), this.selection = r, this.textNode = document.createTextNode(ct.CONTENTS), this.domNode.appendChild(this.textNode), this.savedLength = 0;
  }
  detach() {
  ...
  format(t, e) {
    ...
    r != null && (this.savedLength = ct.CONTENTS.length, r.optimize(), r.formatAt(s, ct.CONTENTS.length, t, e), this.savedLength = 0);
  }
  index(t, e) {
  ...
  restore() {
    ...
    const e = this.prev instanceof Et ? this.prev : null, r = e ? e.length() : 0, s = this.next instanceof Et ? this.next : null, i = s ? s.text : "", {
      textNode: o
    } = this, a = o.data.split(ct.CONTENTS).join("");
    o.data = ct.CONTENTS;
    let c;
    if (e)
  ...
  optimize(t) {
    ...
    for (; e; ) {
      if (e.domNode.tagName === "A") {
        this.savedLength = ct.CONTENTS.length, e.isolate(this.offset(e), this.length()).unwrap(), this.savedLength = 0;
        break;
      }
      e = e.parent;
    }
...
x(ct, "blotName", "cursor"), x(ct, "className", "ql-cursor"), x(ct, "tagName", "span"), x(ct, "CONTENTS", "\uFEFF");
let Ge = ct;
var Do = { exports: {} };
(function(n) {
  ...
  a.prototype.eventNames = function() {
    ...
    if (!this._events[A])
      return !1;
    var v = this._events[A], y = arguments.length, w, T;
    if (v.fn) {
    ...
    if (b.fn)
      ...
      for (var A = 0, v = [], y = b.length; A < y; A++)
        (b[A].fn !== d || g && !b[A].once || m && b[A].context !== m) && v.push(b[A]);
...
var jd = Do.exports;
const Ud = /* @__PURE__ */ Xl(jd), ci = /* @__PURE__ */ new WeakMap(), ui = ["error", "warn", "log", "info"];
let hi = "warn";
function Po(n) {
...
Po.level = Gt.level;
const js = Gt("quill:events"), Fd = ["selectionchange", "mousedown", "mouseup", "click"];
Fd.forEach((n) => {
...
class Gd {
  ...
  applyDelta(t) {
    ...
    return Vd(r.ops.slice()).reduce((o, a) => {
      const c = rt.Op.length(a);
      let h = a.attributes || {}, d = !1, m = !1;
      if (a.insert != null) {
        if (s.retain(c), typeof a.insert == "string") {
          const b = a.insert;
          m = !b.endsWith(`
`) && (e <= o || !!this.scroll.descendant(ft, o)[0]), this.scroll.insertAt(o, b);
          const [A, v] = this.scroll.line(o);
          let y = Qt({}, ut(A));
          if (A instanceof Z) {
            const [w] = A.descendant(Q, v);
            w && (y = Qt(y, ut(w)));
          }
          h = rt.AttributeMap.diff(y, h) || {};
        } else if (typeof a.insert == "object") {
          const b = Object.keys(a.insert)[0];
          if (b == null)
            return o;
          const A = this.scroll.query(b, q.INLINE) != null;
          if (A)
            (e <= o || this.scroll.descendant(ft, o)[0]) && (m = !0);
          else if (o > 0) {
            const [v, y] = this.scroll.descendant(Q, o - 1);
            v instanceof Et ? v.value()[y] !== `
` && (d = !0) : v instanceof ot && v.statics.scope === q.INLINE_BLOT && (d = !0);
          }
          if (this.scroll.insertAt(o, b, a.insert[b]), A) {
...
`));
  ...
  update(t) {
    ...
    e[0].target.data.match(zd) && this.scroll.find(e[0].target)) {
      const i = this.scroll.find(e[0].target), o = ut(i), a = i.offset(this.scroll), c = e[0].oldValue.replace(Ge.CONTENTS, ""), h = new O().insert(c), d = new O().insert(i.value()), m = r && {
...
function _n(n, t, e) {
  ...
  if ("html" in n && typeof n.html == "function")
    return n.html(t, e);
  if (n instanceof Et)
    return Mr(n.value().slice(t, t + e)).replaceAll(" ", "&nbsp;");
  if (n instanceof At) {
...
class Mi extends ot {
  ...
  restore(t) {
    ...
    if (t === this.leftGuard)
      ...
      t === this.rightGuard && (this.next instanceof Et ? (this.next.insertAt(0, s), e = {
...
let Ke = An;
const Zd = (n) => n.parentElement || n.getRootNode().host || null, Xd = (n) => {
...
}, Cl = (n, t, e, r, s, i) => n < e && t > r ? 0 : n < e ? -(e - n + s) : t > r ? t - n > r - e ? n + s - e : t - r + i : 0, Yd = (n, t) => {
  var i, o, a, c, h;
  ...
  for (; s; ) {
    const d = s === e.body, m = d ? {
      ...
      left: 0
    } : Xd(s), g = getComputedStyle(s), p = Cl(r.left, r.right, m.left, m.right, pr(g.scrollPaddingLeft), pr(g.scrollPaddingRight)), b = Cl(r.top, r.bottom, m.top, m.bottom, pr(g.scrollPaddingTop), pr(g.scrollPaddingBottom));
    if (p || b)
      if (d)
        ...
        const y = s.scrollLeft - A, w = s.scrollTop - v;
        r = {
          left: r.left - y,
          top: r.top - w,
          right: r.right - y,
    ...
    s = d || g.position === "fixed" ? null : Zd(s);
  }
}, Jd = 100, Qd = ["block", "break", "cursor", "inline", "scroll", "text"], tg = (n, t, e) => {
  const r = new ze();
  return Qd.forEach((s) => {
    const i = t.query(s);
    i && r.register(i);
    ...
    let o = 0;
    for (; i; )
      if (r.register(i), i = "blotName" in i && (a = i.requiredContainer) != null ? a : null, o += 1, o > Jd) {
...
const yt = class yt {
  ...
  constructor(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (this.options = eg(t, e), this.container = this.options.container, this.container == null) {
    ...
    }), this.editor = new Gd(this.scroll), this.selection = new Hd(this.scroll, this.emitter), this.composition = new Wd(this.scroll, this.emitter), this.theme = new this.options.theme(this, this.options), this.keyboard = this.theme.addModule("keyboard"), this.clipboard = this.theme.addModule("clipboard"), this.history = this.theme.addModule("history"), this.uploader = this.theme.addModule("uploader"), this.theme.addModule("input"), this.theme.addModule("uiNode"), this.theme.init(), this.emitter.on(S.events.EDITOR_CHANGE, (o) => {
...
x(yt, "DEFAULTS", {
  ...
  registry: mr,
  theme: "default"
}), x(yt, "events", S.events), x(yt, "sources", S.sources), x(yt, "version", "2.0.3"), x(yt, "imports", {
  delta: O,
  parchment: xd,
  "core/module": kt,
  "core/theme": Ke
...
function eg(n, t) {
  ...
  let g = t.registry;
  return g ? t.formats && Fe.warn('Ignoring "formats" option because "registry" is specified') : g = t.formats ? tg(t.formats, m.registry, Fe) : m.registry, fe(H({}, m), {
    registry: g,
    container: e,
    theme: s,
    modules: Object.entries(d).reduce((A, v) => {
      let [y, w] = v;
      if (!w)
        return A;
      const T = N.import(`modules/${y}`);
      return T == null ? (Fe.error(`Cannot load ${y} module. Are you sure you registered it?`), A) : fe(H({}, A), {
        // @ts-expect-error
        [y]: Qt({}, T.DEFAULTS || {}, w)
      });
    }, {}),
...
function Bl(n) {
  return n instanceof Z || n instanceof ft;
}
function Ml(n) {
...
class Pe extends Ci {
  ...
  deleteAt(t, e) {
    ...
    if (super.deleteAt(t, e), i != null && r !== i && s > 0) {
      if (r instanceof ft || i instanceof ft) {
        this.optimize();
        return;
      }
...
`))), s = r.pop();
    ...
    const i = r.shift();
    if (i) {
      const c = i.type === "block" && (i.delta.length() === 0 || !this.descendant(ft, t)[0] && t < this.length()), h = i.type === "block" ? i.delta : new O().insert({
        [i.key]: i.value
      });
      Gs(this, t, h);
      ...
      c && this.insertAt(m - 1, `
`);
      const g = ut(this.line(t)[0]), p = rt.AttributeMap.diff(g, i.attributes) || {};
  ...
  updateEmbedAt(t, e, r) {
    const [s] = this.descendant((i) => i instanceof ft, t);
...
x(Pe, "blotName", "scroll"), x(Pe, "className", "ql-editor"), x(Pe, "tagName", "DIV"), x(Pe, "defaultChild", Z), x(Pe, "allowedChildren", [Z, ft, Ae]);
function Gs(n, t, e) {
  e.reduce((r, s) => {
...
}, ng = new Ct("align", "align", $i), Uo = new Nt("align", "ql-align", $i), Fo = new ne("align", "text-align", $i);
class Ho extends ne {
  value(t) {
    let e = super.value(t);
...
const rg = new Nt("color", "ql-color", {
  scope: q.INLINE
}), Di = new Ho("color", "color", {
  scope: q.INLINE
}), sg = new Nt("background", "ql-bg", {
  scope: q.INLINE
...
Ee.tagName = "DIV";
Ee.allowedChildren = [tt];
tt.allowedChildren = [Et, wt, Ge];
tt.requiredContainer = Ee;
const Ui = {
  scope: q.BLOCK,
  whitelist: ["rtl"]
...
const Zo = new ig("font", "font-family", Vo), Xo = new Nt("size", "ql-size", {
  scope: q.INLINE,
  whitelist: ["small", "large", "huge"]
}), Yo = new ne("size", "font-size", {
  scope: q.INLINE,
  whitelist: ["10px", "18px", "32px"]
}), lg = Gt("quill:keyboard"), og = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey";
class $r extends kt {
  static match(t, e) {
  ...
  addBinding(t) {
    ...
    const s = cg(t);
    if (s == null) {
      lg.warn("Attempted to add invalid keyboard binding", s);
      return;
    }
    typeof e == "function" && (e = {
      handler: e
  ...
  listen() {
    this.quill.root.addEventListener("keydown", (t) => {
      ...
      if (o == null || !this.quill.hasFocus())
        return;
      const [a, c] = this.quill.getLine(o.index), [h, d] = this.quill.getLeaf(o.index), [m, g] = o.length === 0 ? [h, d] : this.quill.getLeaf(o.index + o.length), p = h instanceof xr ? h.value().slice(0, d) : "", b = m instanceof xr ? m.value().slice(g) : "", A = {
      ...
      s.some((y) => {
        if (y.collapsed != null && y.collapsed !== A.collapsed || y.empty != null && y.empty !== A.empty || y.offset != null && y.offset !== A.offset)
          return !1;
        if (Array.isArray(y.format)) {
          if (y.format.every((w) => A.format[w] == null))
            return !1;
        } else if (typeof y.format == "object" && !Object.keys(y.format).every((w) => y.format[w] === !0 ? A.format[w] != null : y.format[w] === !1 ? A.format[w] == null : Oi(y.format[w], A.format[w])))
          return !1;
        return y.prefix != null && !y.prefix.test(A.prefix) || y.suffix != null && !y.suffix.test(A.suffix) ? !1 : y.handler.call(this, o, A, y) !== !0;
      }) && t.preventDefault();
    });
  }
  handleBackspace(t, e) {
    ...
    if (e.offset === 0) {
      ...
      if (a && !(a.statics.blotName === "block" && a.length() <= 1)) {
        ...
        if (s = rt.AttributeMap.diff(h, d) || {}, Object.keys(s).length > 0) {
  ...
  handleDelete(t, e) {
    ...
    if (e.offset >= i.length() - 1) {
      ...
      if (a) {
        ...
        s = rt.AttributeMap.diff(c, h) || {}, Object.keys(s).length > 0 && (o = o.retain(a.length() - 1).retain(1, s));
      }
    }
    this.quill.updateContents(o, N.sources.USER), this.quill.focus();
  }
...
`, t.format).retain(e.length() - r - 1).retain(1, {
    ...
    "table enter": {
      ...
      handler(n) {
        ...
        if (t) {
          const [e, r, s, i] = t.getTable(n), o = ug(e, r, s, i);
          if (o == null)
            return;
          let a = e.offset();
          if (o < 0) {
...
function br(n, t) {
  return {
    ...
    handler(r) {
      ...
      return i instanceof ot ? (n === "ArrowLeft" ? t ? this.quill.setSelection(r.index - 1, r.length + 1, N.sources.USER) : this.quill.setSelection(r.index - 1, N.sources.USER) : t ? this.quill.setSelection(r.index, r.length + 1, N.sources.USER) : this.quill.setSelection(r.index + r.length + 1, N.sources.USER), !1) : !0;
    }
  };
}
function Ks(n) {
...
function cg(n) {
  if (typeof n == "string" || typeof n == "number")
    ...
    return null;
  return n.shortKey && (n[og] = n.shortKey, delete n.shortKey), n;
}
function Fi(n) {
  let {
    quill: t,
...
const hg = /font-weight:\s*normal/, fg = ["P", "OL", "UL"], Pl = (n) => n && fg.includes(n.tagName), dg = (n) => {
  ...
  Array.from(n.querySelectorAll('b[style*="font-weight"]')).filter((t) => {
    var e;
    return (e = t.getAttribute("style")) == null ? void 0 : e.match(hg);
  }).forEach((t) => {
    var r;
...
function pg(n) {
  n.querySelector('[id^="docs-internal-guid-"]') && (gg(n), dg(n));
}
const mg = /\bmso-list:[^;]*ignore/i, bg = /\bmso-list:[^;]*\bl(\d+)/i, yg = /\bmso-list:[^;]*\blevel(\d+)/i, vg = (n, t) => {
  const e = n.getAttribute("style"), r = e == null ? void 0 : e.match(bg);
  if (!r)
    return null;
  const s = Number(r[1]), i = e == null ? void 0 : e.match(yg), o = i ? Number(i[1]) : 1, a = new RegExp(`@list l${s}:level${o}\\s*\\{[^\\}]*mso-level-number-format:\\s*([\\w-]+)`, "i"), c = t.match(a), h = c && c[1] === "bullet" ? "bullet" : "ordered";
  return {
    id: s,
    indent: o,
    type: h,
  ...
  t.forEach((c) => {
    (c.getAttribute("style") || "").match(mg) ? e.push(c) : r.push(c);
  }), e.forEach((c) => {
    var h;
    return (h = c.parentNode) == null ? void 0 : h.removeChild(c);
  });
  const s = n.documentElement.innerHTML, i = r.map((c) => vg(c, s)).filter((c) => c);
  for (; i.length; ) {
    const c = [];
    let h = i.shift();
    for (; h; )
...
function Eg(n) {
  n.documentElement.getAttribute("xmlns:w") === "urn:schemas-microsoft-com:office:word" && Ag(n);
}
const Ng = [Eg, pg], wg = (n) => {
  n.documentElement && Ng.forEach((t) => {
    t(n);
  });
}, Tg = Gt("quill:clipboard"), xg = [[Node.TEXT_NODE, $g], [Node.TEXT_NODE, Ul], ["br", qg], [Node.ELEMENT_NODE, Ul], [Node.ELEMENT_NODE, Og], [Node.ELEMENT_NODE, _g], [Node.ELEMENT_NODE, Bg], ["li", Rg], ["ol, ul", kg], ["pre", Cg], ["tr", Mg], ["b", Vs("bold")], ["i", Vs("italic")], ["strike", Vs("strike")], ["style", Ig]], Lg = [ng, zo].reduce((n, t) => (n[t.keyName] = t, n), {}), jl = [Fo, Pi, Di, Ko, Zo, Yo].reduce((n, t) => (n[t.keyName] = t, n), {});
class Jo extends kt {
  constructor(t, e) {
    var r;
    super(t, e), this.quill.root.addEventListener("copy", (s) => this.onCaptureCopy(s, !1)), this.quill.root.addEventListener("cut", (s) => this.onCaptureCopy(s, !0)), this.quill.root.addEventListener("paste", this.onCapturePaste.bind(this)), this.matchers = [], xg.concat((r = this.options.matchers) != null ? r : []).forEach((s) => {
      let [i, o] = s;
      this.addMatcher(i, o);
    });
  }
...
function Yt(n, t) {
  if (!(n instanceof Element))
    return !1;
  const e = t.query(n);
  return e && e.prototype instanceof ot ? !1 : ["address", "article", "blockquote", "canvas", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "iframe", "li", "main", "nav", "ol", "output", "p", "pre", "section", "table", "td", "tr", "ul", "video"].includes(n.tagName.toLowerCase());
}
function Sg(n, t) {
...
function _g(n, t, e) {
  ...
  return r.concat(s).concat(i).forEach((a) => {
    ...
    c != null && (o[c.attrName] = c.value(n), o[c.attrName]) || (c = Lg[a], c != null && (c.attrName === a || c.keyName === a) && (o[c.attrName] = c.value(n) || void 0), c = jl[a], c != null && (c.attrName === a || c.keyName === a) && (c = jl[a], o[c.attrName] = c.value(n) || void 0));
...
`);
        const s = e.query(r);
        if (s && s.prototype instanceof ft)
          return t.insert(`
`);
        r = r.firstChild;
      }
...
class ta extends kt {
  ...
  restoreSelection(e) {
    if (e.range)
      ...
      const r = Pg(this.quill.scroll, e.delta);
...
class Ug extends kt {
  ...
  handleBeforeInput(t) {
    if (this.quill.composition.isComposing || t.defaultPrevented || !jg.includes(t.inputType))
      return;
...
const Hg = /Mac/i.test(navigator.platform), zg = 100, Gg = (n) => !!(n.key === "ArrowLeft" || n.key === "ArrowRight" || // RTL scripts or moving from the end of the previous line
n.key === "ArrowUp" || n.key === "ArrowDown" || n.key === "Home" || Hg && n.key === "a" && n.ctrlKey === !0);
class Kg extends kt {
  constructor(e, r) {
    super(e, r);
  ...
  handleNavigationShortcuts() {
    this.quill.root.addEventListener("keydown", (e) => {
      !e.defaultPrevented && Gg(e) && this.ensureListeningToSelectionChange();
    });
  }
  /**
  ...
  ensureListeningToSelectionChange() {
    if (this.selectionChangeDeadline = Date.now() + zg, this.isListening)
      return;
    this.isListening = !0;
    const e = () => {
...
const Wg = new Vg("indent", "ql-indent", {
  scope: q.BLOCK,
  // @ts-expect-error
...
x(Ar, "blotName", "formula"), x(Ar, "className", "ql-formula"), x(Ar, "tagName", "SPAN");
...
x(Er, "blotName", "video"), x(Er, "className", "ql-video"), x(Er, "tagName", "IFRAME");
...
class vn extends Ee {
  ...
  format(t, e) {
    t === ht.blotName && (this.forceNext = !0, this.children.forEach((r) => {
      r.format(t, e);
    }));
  }
  formatAt(t, e, r, s) {
    r === ht.blotName && (this.forceNext = !0), super.formatAt(t, e, r, s);
  }
  highlight(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
...
`)}
`, i = ht.formats(this.children.head.domNode);
      ...
      if (s.trim().length > 0 || this.cachedText == null) {
        ...
        o.diff(a).reduce((c, h) => {
          ...
          return d ? (m && Object.keys(m).forEach((g) => {
            [ht.blotName, Ft.blotName].includes(g) && this.formatAt(c, d, g, m[g]);
          }), c + d) : c;
        }, 0);
      }
  ...
  html(t, e) {
    ...
    return `<pre data-language="${r ? ht.formats(r.domNode) : "plain"}">
${Mr(this.code(t, e))}
</pre>`;
  }
  optimize(t) {
    if (super.optimize(t), this.parent != null && this.children.head != null && this.uiNode != null) {
      const e = ht.formats(this.children.head.domNode);
      e !== this.uiNode.value && (this.uiNode.value = e);
    }
  }
}
vn.allowedChildren = [ht];
ht.requiredContainer = vn;
ht.allowedChildren = [Ft, Ge, Et, wt];
const Zg = (n, t, e) => {
...
class ra extends kt {
  static register() {
    N.register(Ft, !0), N.register(ht, !0), N.register(vn, !0);
  }
  constructor(t, e) {
  ...
  initListener() {
    this.quill.on(N.events.SCROLL_BLOT_MOUNT, (t) => {
      ...
      this.options.languages.forEach((r) => {
        ...
        t.format(ht.blotName, e.value), this.quill.root.focus(), this.highlight(t, !0);
      }), t.uiNode == null && (t.attachUI(e), t.children.head && (e.value = ht.formats(t.children.head.domNode)));
    });
  }
  initTimer() {
    let t = null;
...
`, {
    ...
    return r.classList.add(tt.className), r.innerHTML = Zg(this.options.hljs, e, t), Hi(this.quill.scroll, r, [(s, i) => {
      const o = bn.value(s);
  ...
  attach(t) {
    ...
    t.addEventListener(r, (s) => {
      ...
      if (this.handlers[e] != null)
        ...
        // @ts-expect-error
        this.quill.scroll.query(e).prototype instanceof ot
      ) {
  ...
  Array.isArray(t[0]) || (t = [t]), t.forEach((e) => {
    ...
    r.classList.add("ql-formats"), e.forEach((s) => {
      if (typeof s == "string")
        ...
        Array.isArray(o) ? Jg(r, i, o) : Kl(r, i, o);
      }
    }), n.appendChild(r);
  });
}
...
const Qg = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="3" x2="15" y1="9" y2="9"/><line class="ql-stroke" x1="3" x2="13" y1="14" y2="14"/><line class="ql-stroke" x1="3" x2="9" y1="4" y2="4"/></svg>', tp = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="15" x2="3" y1="9" y2="9"/><line class="ql-stroke" x1="14" x2="4" y1="14" y2="14"/><line class="ql-stroke" x1="12" x2="6" y1="4" y2="4"/></svg>', ep = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="15" x2="3" y1="9" y2="9"/><line class="ql-stroke" x1="15" x2="5" y1="14" y2="14"/><line class="ql-stroke" x1="15" x2="9" y1="4" y2="4"/></svg>', np = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="15" x2="3" y1="9" y2="9"/><line class="ql-stroke" x1="15" x2="3" y1="14" y2="14"/><line class="ql-stroke" x1="15" x2="3" y1="4" y2="4"/></svg>', rp = '<svg viewbox="0 0 18 18"><g class="ql-fill ql-color-label"><polygon points="6 6.868 6 6 5 6 5 7 5.942 7 6 6.868"/><rect height="1" width="1" x="4" y="4"/><polygon points="6.817 5 6 5 6 6 6.38 6 6.817 5"/><rect height="1" width="1" x="2" y="6"/><rect height="1" width="1" x="3" y="5"/><rect height="1" width="1" x="4" y="7"/><polygon points="4 11.439 4 11 3 11 3 12 3.755 12 4 11.439"/><rect height="1" width="1" x="2" y="12"/><rect height="1" width="1" x="2" y="9"/><rect height="1" width="1" x="2" y="15"/><polygon points="4.63 10 4 10 4 11 4.192 11 4.63 10"/><rect height="1" width="1" x="3" y="8"/><path d="M10.832,4.2L11,4.582V4H10.708A1.948,1.948,0,0,1,10.832,4.2Z"/><path d="M7,4.582L7.168,4.2A1.929,1.929,0,0,1,7.292,4H7V4.582Z"/><path d="M8,13H7.683l-0.351.8a1.933,1.933,0,0,1-.124.2H8V13Z"/><rect height="1" width="1" x="12" y="2"/><rect height="1" width="1" x="11" y="3"/><path d="M9,3H8V3.282A1.985,1.985,0,0,1,9,3Z"/><rect height="1" width="1" x="2" y="3"/><rect height="1" width="1" x="6" y="2"/><rect height="1" width="1" x="3" y="2"/><rect height="1" width="1" x="5" y="3"/><rect height="1" width="1" x="9" y="2"/><rect height="1" width="1" x="15" y="14"/><polygon points="13.447 10.174 13.469 10.225 13.472 10.232 13.808 11 14 11 14 10 13.37 10 13.447 10.174"/><rect height="1" width="1" x="13" y="7"/><rect height="1" width="1" x="15" y="5"/><rect height="1" width="1" x="14" y="6"/><rect height="1" width="1" x="15" y="8"/><rect height="1" width="1" x="14" y="9"/><path d="M3.775,14H3v1H4V14.314A1.97,1.97,0,0,1,3.775,14Z"/><rect height="1" width="1" x="14" y="3"/><polygon points="12 6.868 12 6 11.62 6 12 6.868"/><rect height="1" width="1" x="15" y="2"/><rect height="1" width="1" x="12" y="5"/><rect height="1" width="1" x="13" y="4"/><polygon points="12.933 9 13 9 13 8 12.495 8 12.933 9"/><rect height="1" width="1" x="9" y="14"/><rect height="1" width="1" x="8" y="15"/><path d="M6,14.926V15H7V14.316A1.993,1.993,0,0,1,6,14.926Z"/><rect height="1" width="1" x="5" y="15"/><path d="M10.668,13.8L10.317,13H10v1h0.792A1.947,1.947,0,0,1,10.668,13.8Z"/><rect height="1" width="1" x="11" y="15"/><path d="M14.332,12.2a1.99,1.99,0,0,1,.166.8H15V12H14.245Z"/><rect height="1" width="1" x="14" y="15"/><rect height="1" width="1" x="15" y="11"/></g><polyline class="ql-stroke" points="5.5 13 9 5 12.5 13"/><line class="ql-stroke" x1="11.63" x2="6.38" y1="11" y2="11"/></svg>', sp = '<svg viewbox="0 0 18 18"><rect class="ql-fill ql-stroke" height="3" width="3" x="4" y="5"/><rect class="ql-fill ql-stroke" height="3" width="3" x="11" y="5"/><path class="ql-even ql-fill ql-stroke" d="M7,8c0,4.031-3,5-3,5"/><path class="ql-even ql-fill ql-stroke" d="M14,8c0,4.031-3,5-3,5"/></svg>', ip = '<svg viewbox="0 0 18 18"><path class="ql-stroke" d="M5,4H9.5A2.5,2.5,0,0,1,12,6.5v0A2.5,2.5,0,0,1,9.5,9H5A0,0,0,0,1,5,9V4A0,0,0,0,1,5,4Z"/><path class="ql-stroke" d="M5,9h5.5A2.5,2.5,0,0,1,13,11.5v0A2.5,2.5,0,0,1,10.5,14H5a0,0,0,0,1,0,0V9A0,0,0,0,1,5,9Z"/></svg>', lp = '<svg class="" viewbox="0 0 18 18"><line class="ql-stroke" x1="5" x2="13" y1="3" y2="3"/><line class="ql-stroke" x1="6" x2="9.35" y1="12" y2="3"/><line class="ql-stroke" x1="11" x2="15" y1="11" y2="15"/><line class="ql-stroke" x1="15" x2="11" y1="11" y2="15"/><rect class="ql-fill" height="1" rx="0.5" ry="0.5" width="7" x="2" y="14"/></svg>', Vl = '<svg viewbox="0 0 18 18"><polyline class="ql-even ql-stroke" points="5 7 3 9 5 11"/><polyline class="ql-even ql-stroke" points="13 7 15 9 13 11"/><line class="ql-stroke" x1="10" x2="8" y1="5" y2="13"/></svg>', op = '<svg viewbox="0 0 18 18"><line class="ql-color-label ql-stroke ql-transparent" x1="3" x2="15" y1="15" y2="15"/><polyline class="ql-stroke" points="5.5 11 9 3 12.5 11"/><line class="ql-stroke" x1="11.63" x2="6.38" y1="9" y2="9"/></svg>', ap = '<svg viewbox="0 0 18 18"><polygon class="ql-stroke ql-fill" points="3 11 5 9 3 7 3 11"/><line class="ql-stroke ql-fill" x1="15" x2="11" y1="4" y2="4"/><path class="ql-fill" d="M11,3a3,3,0,0,0,0,6h1V3H11Z"/><rect class="ql-fill" height="11" width="1" x="11" y="4"/><rect class="ql-fill" height="11" width="1" x="13" y="4"/></svg>', cp = '<svg viewbox="0 0 18 18"><polygon class="ql-stroke ql-fill" points="15 12 13 10 15 8 15 12"/><line class="ql-stroke ql-fill" x1="9" x2="5" y1="4" y2="4"/><path class="ql-fill" d="M5,3A3,3,0,0,0,5,9H6V3H5Z"/><rect class="ql-fill" height="11" width="1" x="5" y="4"/><rect class="ql-fill" height="11" width="1" x="7" y="4"/></svg>', up = '<svg viewbox="0 0 18 18"><path class="ql-fill" d="M11.759,2.482a2.561,2.561,0,0,0-3.53.607A7.656,7.656,0,0,0,6.8,6.2C6.109,9.188,5.275,14.677,4.15,14.927a1.545,1.545,0,0,0-1.3-.933A0.922,0.922,0,0,0,2,15.036S1.954,16,4.119,16s3.091-2.691,3.7-5.553c0.177-.826.36-1.726,0.554-2.6L8.775,6.2c0.381-1.421.807-2.521,1.306-2.676a1.014,1.014,0,0,0,1.02.56A0.966,0.966,0,0,0,11.759,2.482Z"/><rect class="ql-fill" height="1.6" rx="0.8" ry="0.8" width="5" x="5.15" y="6.2"/><path class="ql-fill" d="M13.663,12.027a1.662,1.662,0,0,1,.266-0.276q0.193,0.069.456,0.138a2.1,2.1,0,0,0,.535.069,1.075,1.075,0,0,0,.767-0.3,1.044,1.044,0,0,0,.314-0.8,0.84,0.84,0,0,0-.238-0.619,0.8,0.8,0,0,0-.594-0.239,1.154,1.154,0,0,0-.781.3,4.607,4.607,0,0,0-.781,1q-0.091.15-.218,0.346l-0.246.38c-0.068-.288-0.137-0.582-0.212-0.885-0.459-1.847-2.494-.984-2.941-0.8-0.482.2-.353,0.647-0.094,0.529a0.869,0.869,0,0,1,1.281.585c0.217,0.751.377,1.436,0.527,2.038a5.688,5.688,0,0,1-.362.467,2.69,2.69,0,0,1-.264.271q-0.221-.08-0.471-0.147a2.029,2.029,0,0,0-.522-0.066,1.079,1.079,0,0,0-.768.3A1.058,1.058,0,0,0,9,15.131a0.82,0.82,0,0,0,.832.852,1.134,1.134,0,0,0,.787-0.3,5.11,5.11,0,0,0,.776-0.993q0.141-.219.215-0.34c0.046-.076.122-0.194,0.223-0.346a2.786,2.786,0,0,0,.918,1.726,2.582,2.582,0,0,0,2.376-.185c0.317-.181.212-0.565,0-0.494A0.807,0.807,0,0,1,14.176,15a5.159,5.159,0,0,1-.913-2.446l0,0Q13.487,12.24,13.663,12.027Z"/></svg>', hp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M10,4V14a1,1,0,0,1-2,0V10H3v4a1,1,0,0,1-2,0V4A1,1,0,0,1,3,4V8H8V4a1,1,0,0,1,2,0Zm6.06787,9.209H14.98975V7.59863a.54085.54085,0,0,0-.605-.60547h-.62744a1.01119,1.01119,0,0,0-.748.29688L11.645,8.56641a.5435.5435,0,0,0-.022.8584l.28613.30762a.53861.53861,0,0,0,.84717.0332l.09912-.08789a1.2137,1.2137,0,0,0,.2417-.35254h.02246s-.01123.30859-.01123.60547V13.209H12.041a.54085.54085,0,0,0-.605.60547v.43945a.54085.54085,0,0,0,.605.60547h4.02686a.54085.54085,0,0,0,.605-.60547v-.43945A.54085.54085,0,0,0,16.06787,13.209Z"/></svg>', fp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M16.73975,13.81445v.43945a.54085.54085,0,0,1-.605.60547H11.855a.58392.58392,0,0,1-.64893-.60547V14.0127c0-2.90527,3.39941-3.42187,3.39941-4.55469a.77675.77675,0,0,0-.84717-.78125,1.17684,1.17684,0,0,0-.83594.38477c-.2749.26367-.561.374-.85791.13184l-.4292-.34082c-.30811-.24219-.38525-.51758-.1543-.81445a2.97155,2.97155,0,0,1,2.45361-1.17676,2.45393,2.45393,0,0,1,2.68408,2.40918c0,2.45312-3.1792,2.92676-3.27832,3.93848h2.79443A.54085.54085,0,0,1,16.73975,13.81445ZM9,3A.99974.99974,0,0,0,8,4V8H3V4A1,1,0,0,0,1,4V14a1,1,0,0,0,2,0V10H8v4a1,1,0,0,0,2,0V4A.99974.99974,0,0,0,9,3Z"/></svg>', dp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M16.65186,12.30664a2.6742,2.6742,0,0,1-2.915,2.68457,3.96592,3.96592,0,0,1-2.25537-.6709.56007.56007,0,0,1-.13232-.83594L11.64648,13c.209-.34082.48389-.36328.82471-.1543a2.32654,2.32654,0,0,0,1.12256.33008c.71484,0,1.12207-.35156,1.12207-.78125,0-.61523-.61621-.86816-1.46338-.86816H13.2085a.65159.65159,0,0,1-.68213-.41895l-.05518-.10937a.67114.67114,0,0,1,.14307-.78125l.71533-.86914a8.55289,8.55289,0,0,1,.68213-.7373V8.58887a3.93913,3.93913,0,0,1-.748.05469H11.9873a.54085.54085,0,0,1-.605-.60547V7.59863a.54085.54085,0,0,1,.605-.60547h3.75146a.53773.53773,0,0,1,.60547.59375v.17676a1.03723,1.03723,0,0,1-.27539.748L14.74854,10.0293A2.31132,2.31132,0,0,1,16.65186,12.30664ZM9,3A.99974.99974,0,0,0,8,4V8H3V4A1,1,0,0,0,1,4V14a1,1,0,0,0,2,0V10H8v4a1,1,0,0,0,2,0V4A.99974.99974,0,0,0,9,3Z"/></svg>', gp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M10,4V14a1,1,0,0,1-2,0V10H3v4a1,1,0,0,1-2,0V4A1,1,0,0,1,3,4V8H8V4a1,1,0,0,1,2,0Zm7.05371,7.96582v.38477c0,.39648-.165.60547-.46191.60547h-.47314v1.29785a.54085.54085,0,0,1-.605.60547h-.69336a.54085.54085,0,0,1-.605-.60547V12.95605H11.333a.5412.5412,0,0,1-.60547-.60547v-.15332a1.199,1.199,0,0,1,.22021-.748l2.56348-4.05957a.7819.7819,0,0,1,.72607-.39648h1.27637a.54085.54085,0,0,1,.605.60547v3.7627h.33008A.54055.54055,0,0,1,17.05371,11.96582ZM14.28125,8.7207h-.022a4.18969,4.18969,0,0,1-.38525.81348l-1.188,1.80469v.02246h1.5293V9.60059A7.04058,7.04058,0,0,1,14.28125,8.7207Z"/></svg>', pp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M16.74023,12.18555a2.75131,2.75131,0,0,1-2.91553,2.80566,3.908,3.908,0,0,1-2.25537-.68164.54809.54809,0,0,1-.13184-.8252L11.73438,13c.209-.34082.48389-.36328.8252-.1543a2.23757,2.23757,0,0,0,1.1001.33008,1.01827,1.01827,0,0,0,1.1001-.96777c0-.61621-.53906-.97949-1.25439-.97949a2.15554,2.15554,0,0,0-.64893.09961,1.15209,1.15209,0,0,1-.814.01074l-.12109-.04395a.64116.64116,0,0,1-.45117-.71484l.231-3.00391a.56666.56666,0,0,1,.62744-.583H15.541a.54085.54085,0,0,1,.605.60547v.43945a.54085.54085,0,0,1-.605.60547H13.41748l-.04395.72559a1.29306,1.29306,0,0,1-.04395.30859h.022a2.39776,2.39776,0,0,1,.57227-.07715A2.53266,2.53266,0,0,1,16.74023,12.18555ZM9,3A.99974.99974,0,0,0,8,4V8H3V4A1,1,0,0,0,1,4V14a1,1,0,0,0,2,0V10H8v4a1,1,0,0,0,2,0V4A.99974.99974,0,0,0,9,3Z"/></svg>', mp = '<svg viewBox="0 0 18 18"><path class="ql-fill" d="M14.51758,9.64453a1.85627,1.85627,0,0,0-1.24316.38477H13.252a1.73532,1.73532,0,0,1,1.72754-1.4082,2.66491,2.66491,0,0,1,.5498.06641c.35254.05469.57227.01074.70508-.40723l.16406-.5166a.53393.53393,0,0,0-.373-.75977,4.83723,4.83723,0,0,0-1.17773-.14258c-2.43164,0-3.7627,2.17773-3.7627,4.43359,0,2.47559,1.60645,3.69629,3.19043,3.69629A2.70585,2.70585,0,0,0,16.96,12.19727,2.43861,2.43861,0,0,0,14.51758,9.64453Zm-.23047,3.58691c-.67187,0-1.22168-.81445-1.22168-1.45215,0-.47363.30762-.583.72559-.583.96875,0,1.27734.59375,1.27734,1.12207A.82182.82182,0,0,1,14.28711,13.23145ZM10,4V14a1,1,0,0,1-2,0V10H3v4a1,1,0,0,1-2,0V4A1,1,0,0,1,3,4V8H8V4a1,1,0,0,1,2,0Z"/></svg>', bp = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="7" x2="13" y1="4" y2="4"/><line class="ql-stroke" x1="5" x2="11" y1="14" y2="14"/><line class="ql-stroke" x1="8" x2="10" y1="14" y2="4"/></svg>', yp = '<svg viewbox="0 0 18 18"><rect class="ql-stroke" height="10" width="12" x="3" y="4"/><circle class="ql-fill" cx="6" cy="7" r="1"/><polyline class="ql-even ql-fill" points="5 12 5 11 7 9 8 10 11 7 13 9 13 12 5 12"/></svg>', vp = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="3" x2="15" y1="14" y2="14"/><line class="ql-stroke" x1="3" x2="15" y1="4" y2="4"/><line class="ql-stroke" x1="9" x2="15" y1="9" y2="9"/><polyline class="ql-fill ql-stroke" points="3 7 3 11 5 9 3 7"/></svg>', Ap = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="3" x2="15" y1="14" y2="14"/><line class="ql-stroke" x1="3" x2="15" y1="4" y2="4"/><line class="ql-stroke" x1="9" x2="15" y1="9" y2="9"/><polyline class="ql-stroke" points="5 7 5 11 3 9 5 7"/></svg>', Ep = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="7" x2="11" y1="7" y2="11"/><path class="ql-even ql-stroke" d="M8.9,4.577a3.476,3.476,0,0,1,.36,4.679A3.476,3.476,0,0,1,4.577,8.9C3.185,7.5,2.035,6.4,4.217,4.217S7.5,3.185,8.9,4.577Z"/><path class="ql-even ql-stroke" d="M13.423,9.1a3.476,3.476,0,0,0-4.679-.36,3.476,3.476,0,0,0,.36,4.679c1.392,1.392,2.5,2.542,4.679.36S14.815,10.5,13.423,9.1Z"/></svg>', Np = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="6" x2="15" y1="4" y2="4"/><line class="ql-stroke" x1="6" x2="15" y1="9" y2="9"/><line class="ql-stroke" x1="6" x2="15" y1="14" y2="14"/><line class="ql-stroke" x1="3" x2="3" y1="4" y2="4"/><line class="ql-stroke" x1="3" x2="3" y1="9" y2="9"/><line class="ql-stroke" x1="3" x2="3" y1="14" y2="14"/></svg>', wp = '<svg class="" viewbox="0 0 18 18"><line class="ql-stroke" x1="9" x2="15" y1="4" y2="4"/><polyline class="ql-stroke" points="3 4 4 5 6 3"/><line class="ql-stroke" x1="9" x2="15" y1="14" y2="14"/><polyline class="ql-stroke" points="3 14 4 15 6 13"/><line class="ql-stroke" x1="9" x2="15" y1="9" y2="9"/><polyline class="ql-stroke" points="3 9 4 10 6 8"/></svg>', Tp = '<svg viewbox="0 0 18 18"><line class="ql-stroke" x1="7" x2="15" y1="4" y2="4"/><line class="ql-stroke" x1="7" x2="15" y1="9" y2="9"/><line class="ql-stroke" x1="7" x2="15" y1="14" y2="14"/><line class="ql-stroke ql-thin" x1="2.5" x2="4.5" y1="5.5" y2="5.5"/><path class="ql-fill" d="M3.5,6A0.5,0.5,0,0,1,3,5.5V3.085l-0.276.138A0.5,0.5,0,0,1,2.053,3c-0.124-.247-0.023-0.324.224-0.447l1-.5A0.5,0.5,0,0,1,4,2.5v3A0.5,0.5,0,0,1,3.5,6Z"/><path class="ql-stroke ql-thin" d="M4.5,10.5h-2c0-.234,1.85-1.076,1.85-2.234A0.959,0.959,0,0,0,2.5,8.156"/><path class="ql-stroke ql-thin" d="M2.5,14.846a0.959,0.959,0,0,0,1.85-.109A0.7,0.7,0,0,0,3.75,14a0.688,0.688,0,0,0,.6-0.736,0.959,0.959,0,0,0-1.85-.109"/></svg>', xp = '<svg viewbox="0 0 18 18"><path class="ql-fill" d="M15.5,15H13.861a3.858,3.858,0,0,0,1.914-2.975,1.8,1.8,0,0,0-1.6-1.751A1.921,1.921,0,0,0,12.021,11.7a0.50013,0.50013,0,1,0,.957.291h0a0.914,0.914,0,0,1,1.053-.725,0.81,0.81,0,0,1,.744.762c0,1.076-1.16971,1.86982-1.93971,2.43082A1.45639,1.45639,0,0,0,12,15.5a0.5,0.5,0,0,0,.5.5h3A0.5,0.5,0,0,0,15.5,15Z"/><path class="ql-fill" d="M9.65,5.241a1,1,0,0,0-1.409.108L6,7.964,3.759,5.349A1,1,0,0,0,2.192,6.59178Q2.21541,6.6213,2.241,6.649L4.684,9.5,2.241,12.35A1,1,0,0,0,3.71,13.70722q0.02557-.02768.049-0.05722L6,11.036,8.241,13.65a1,1,0,1,0,1.567-1.24277Q9.78459,12.3777,9.759,12.35L7.316,9.5,9.759,6.651A1,1,0,0,0,9.65,5.241Z"/></svg>', Lp = '<svg viewbox="0 0 18 18"><path class="ql-fill" d="M15.5,7H13.861a4.015,4.015,0,0,0,1.914-2.975,1.8,1.8,0,0,0-1.6-1.751A1.922,1.922,0,0,0,12.021,3.7a0.5,0.5,0,1,0,.957.291,0.917,0.917,0,0,1,1.053-.725,0.81,0.81,0,0,1,.744.762c0,1.077-1.164,1.925-1.934,2.486A1.423,1.423,0,0,0,12,7.5a0.5,0.5,0,0,0,.5.5h3A0.5,0.5,0,0,0,15.5,7Z"/><path class="ql-fill" d="M9.651,5.241a1,1,0,0,0-1.41.108L6,7.964,3.759,5.349a1,1,0,1,0-1.519,1.3L4.683,9.5,2.241,12.35a1,1,0,1,0,1.519,1.3L6,11.036,8.241,13.65a1,1,0,0,0,1.519-1.3L7.317,9.5,9.759,6.651A1,1,0,0,0,9.651,5.241Z"/></svg>', Sp = '<svg viewbox="0 0 18 18"><line class="ql-stroke ql-thin" x1="15.5" x2="2.5" y1="8.5" y2="9.5"/><path class="ql-fill" d="M9.007,8C6.542,7.791,6,7.519,6,6.5,6,5.792,7.283,5,9,5c1.571,0,2.765.679,2.969,1.309a1,1,0,0,0,1.9-.617C13.356,4.106,11.354,3,9,3,6.2,3,4,4.538,4,6.5a3.2,3.2,0,0,0,.5,1.843Z"/><path class="ql-fill" d="M8.984,10C11.457,10.208,12,10.479,12,11.5c0,0.708-1.283,1.5-3,1.5-1.571,0-2.765-.679-2.969-1.309a1,1,0,1,0-1.9.617C4.644,13.894,6.646,15,9,15c2.8,0,5-1.538,5-3.5a3.2,3.2,0,0,0-.5-1.843Z"/></svg>', _p = '<svg viewbox="0 0 18 18"><rect class="ql-stroke" height="12" width="12" x="3" y="3"/><rect class="ql-fill" height="2" width="3" x="5" y="5"/><rect class="ql-fill" height="2" width="4" x="9" y="5"/><g class="ql-fill ql-transparent"><rect height="2" width="3" x="5" y="8"/><rect height="2" width="4" x="9" y="8"/><rect height="2" width="3" x="5" y="11"/><rect height="2" width="4" x="9" y="11"/></g></svg>', Op = '<svg viewbox="0 0 18 18"><path class="ql-stroke" d="M5,3V9a4.012,4.012,0,0,0,4,4H9a4.012,4.012,0,0,0,4-4V3"/><rect class="ql-fill" height="1" rx="0.5" ry="0.5" width="12" x="3" y="15"/></svg>', qp = '<svg viewbox="0 0 18 18"><rect class="ql-stroke" height="12" width="12" x="3" y="3"/><rect class="ql-fill" height="12" width="1" x="5" y="3"/><rect class="ql-fill" height="12" width="1" x="12" y="3"/><rect class="ql-fill" height="2" width="8" x="5" y="8"/><rect class="ql-fill" height="1" width="3" x="3" y="5"/><rect class="ql-fill" height="1" width="3" x="3" y="7"/><rect class="ql-fill" height="1" width="3" x="3" y="10"/><rect class="ql-fill" height="1" width="3" x="3" y="12"/><rect class="ql-fill" height="1" width="3" x="12" y="5"/><rect class="ql-fill" height="1" width="3" x="12" y="7"/><rect class="ql-fill" height="1" width="3" x="12" y="10"/><rect class="ql-fill" height="1" width="3" x="12" y="12"/></svg>', qn = {
  align: {
    "": Qg,
    center: tp,
    right: ep,
  ...
  underline: Op,
  video: qp
}, Cp = '<svg viewbox="0 0 18 18"><polygon class="ql-stroke" points="7 11 9 13 11 11 7 11"/><polygon class="ql-stroke" points="7 7 9 5 11 7 7 7"/></svg>';
let Wl = 0;
function Zl(n, t) {
...
class Dr {
  ...
  buildLabel() {
    ...
    return t.classList.add("ql-picker-label"), t.innerHTML = Cp, t.tabIndex = "0", t.setAttribute("role", "button"), t.setAttribute("aria-expanded", "false"), this.container.appendChild(t), t;
  }
  buildOptions() {
    const t = document.createElement("span");
...
class la {
  constructor(t, e) {
    this.quill = t, this.boundsContainer = e || document.body, this.root = t.addContainer("ql-tooltip"), this.root.innerHTML = this.constructor.TEMPLATE, Ip(this.quill.root) && this.quill.root.addEventListener("scroll", () => {
...
const Rp = [!1, "center", "right", "justify"], kp = ["#000000", "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc", "#9933ff", "#ffffff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"], Bp = [!1, "serif", "monospace"], Mp = ["1", "2", "3", !1], $p = ["small", !1, "large", "huge"];
class $n extends Ke {
  constructor(t, e) {
    super(t, e);
    const r = (s) => {
  ...
  buildPickers(t, e) {
    this.pickers = Array.from(t).map((s) => {
      if (s.classList.contains("ql-align") && (s.querySelector("option") == null && mn(s, Rp), typeof e.align == "object"))
      ...
      if (s.classList.contains("ql-background") || s.classList.contains("ql-color")) {
        ...
        return s.querySelector("option") == null && mn(s, kp, i === "background" ? "#ffffff" : "#000000"), new sa(s, e[i]);
      }
      return s.querySelector("option") == null && (s.classList.contains("ql-font") ? mn(s, Bp) : s.classList.contains("ql-header") ? mn(s, Mp) : s.classList.contains("ql-size") && mn(s, $p)), new Dr(s);
    });
    const r = () => {
...
class ca extends $n {
  constructor(t, e) {
    e.modules.toolbar != null && e.modules.toolbar.container == null && (e.modules.toolbar.container = Pp), super(t, e), this.quill.container.classList.add("ql-bubble");
  }
  extendToolbar(t) {
...
class ha extends $n {
  constructor(t, e) {
    e.modules.toolbar != null && e.modules.toolbar.container == null && (e.modules.toolbar.container = jp), super(t, e), this.quill.container.classList.add("ql-snow");
  }
  extendToolbar(t) {
...
N.register({
  ...
  "attributors/class/background": sg,
...
const Wp = rt.AttributeMap, Zp = rt.Op, Xp = rt.OpIterator;
export {
  Wp as AttributeMap,
  O as Delta,
  kt as Module,
