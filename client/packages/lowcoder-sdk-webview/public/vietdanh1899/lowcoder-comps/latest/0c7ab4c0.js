import { r as I, e as b, f as q, b7 as Q, j as E, l as g, C as j, I as lt } from "./ec63fa57.js";
import { a as st } from "./040a37c0.js";
import { l as ct } from "./ec5a31e0.js";
const ht = (e, t, a, i) => {
  t.forEach((l) => {
    wt[l](e, a, i);
  });
...
const vt = (e, t, a, i) => {
  let l = e || "";
  if (typeof l == "object" && (l = l[0]), I(b().flowchart.htmlLabels)) {
  ...
  let l;
  const r = t.useHtmlLabels || I(b().flowchart.htmlLabels);
...
function Tt(e, t, a) {
  ...
  return r.length ? (r.length > 1 && r.sort(function(d, k) {
    var x = d.x - a.x, u = d.y - a.y, S = Math.sqrt(x * x + u * u), B = k.x - a.x, C = k.y - a.y, W = Math.sqrt(B * B + C * C);
...
const Bt = (e, t) => {
  ...
  const { shapeSvg: a, bbox: i } = await M(e, t, void 0, !0), l = 2, r = i.height + 2 * t.padding, s = r / l, n = i.width + 2 * s + t.padding, c = Rt(t.directions, i, t), o = H(a, n, r, c);
  return o.attr("style", t.style), m(t, o), t.intersect = function(h) {
    return w.polygon(t, c, h);
  }, a;
}, Ot = async (e, t) => {
  ...
  return H(a, l, r, s).attr("style", t.style), t.width = l + r, t.height = r, t.intersect = function(c) {
...
const Gt = (e, t) => {
  ...
  ), p += C.height + i, c.attr("class", "divider").attr("x1", -h / 2 - a).attr("x2", h / 2 + a).attr("y1", -y / 2 - a + l + p).attr("y2", -y / 2 - a + l + p), p += l, W.forEach((v) => {
    E(v).attr(
      "transform",
...
const xr = () => {
  ...
  const a = I(b().flowchart.htmlLabels), i = t.labelType === "markdown" ? st(e, t.label, {
    style: t.labelStyle,
    useHtmlLabels: a,
    addSvgBackground: !0
