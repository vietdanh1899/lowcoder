import { c as hi, g as rl, l as Er, e as ci, U as al, v as nl, W as ja, f as en, j as il, at as sl, au as ol, av as ul, Y as ll } from "./35fc2a31.js";
import { a as fl } from "./0b7baa5a.js";
function Xe(t) {
...
var Ca = vf, qi = 0 / 0, df = /^[-+]0x[0-9a-f]+$/i, gf = /^0b[01]+$/i, pf = /^0o[0-7]+$/i, yf = parseInt;
function mf(t) {
  if (typeof t == "number")
    return t;
  if (Ca(t))
        ...
        function(r) {
          ...
          function(r, a, n) {
            ...
            var o = function(d) {
              ...
              function h(d) {
                var c = this;
                s(this, h), this.length = 0, this.head = null, this.tail = null, d?.forEach(function(v) {
                  return c.push(v);
                });
              }
              return i(h, [{
