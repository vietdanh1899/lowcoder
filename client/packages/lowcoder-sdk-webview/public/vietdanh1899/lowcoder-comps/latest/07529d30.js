  ...
  var e = function(f1, a, o, f) {
    ...
    parse: function(a) {
      ...
      for (var U, E1, j, ht, v1 = {}, q1, n1, zt, Q1; ; ) {
        if (E1 = f[f.length - 1], this.defaultActions[E1] ? j = this.defaultActions[E1] : ((U === null || typeof U > "u") && (U = Be()), j = N1[E1] && N1[E1][U]), typeof j > "u" || !j.length || !j[0]) {
          var ft = "";
          Q1 = [];
          for (q1 in N1[E1])
...
Expecting ` + Q1.join(", ") + ", got '" + (this.terminals_[U] || U) + "'" : ft = "Parse error on line " + (Y + 1) + ": Unexpected " + (U == jt ? "end of input" : "'" + (this.terminals_[U] || U) + "'"), this.parseError(ft, {
        ...
        switch (j[0]) {
          case 1:
            f.push(U), C.push(_.yytext), t.push(_.yylloc), f.push(j[1]), U = null, Yt = _.yyleng, s = _.yytext, Y = _.yylineno, lt = _.yylloc;
            break;
          case 2:
...
const it = (e) => we.sanitizeText(e, L1), P1 = function(e) {
  ...
  F !== void 0 && F.trim().length !== 0 && (D[F] === void 0 && (D[F] = {
    ...
    styles: [],
    classes: []
  }), Xt++, u !== void 0 ? (L1 = et(), G = it(u.text.trim()), D[F].labelType = u.type, G[0] === '"' && G[G.length - 1] === '"' && (G = G.substring(1, G.length - 1)), D[F].text = G) : D[F].text === void 0 && (D[F].text = e), i !== void 0 && (D[F].type = i), n?.forEach(function(w) {
    D[F].styles.push(w);
...
const oe = function(e = "gen-1") {
  ...
  let h = [];
  const { nodeList: G, dir: F } = l(h.concat.apply(h, u));
  if (h = G, st === "gen-1")
