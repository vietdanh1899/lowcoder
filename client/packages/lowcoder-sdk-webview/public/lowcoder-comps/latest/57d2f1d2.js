import { e as rt, a as mt, s as kt, b as _t, d as xt, G as vt, F as bt, H as wt, m as St, ar as Lt, j as G, v as Et } from "./54c8ca06.js";
...
function jt() {
  ...
  x.update = function(e) {
    ...
    return arguments.length ? (p = typeof e == "function" ? e : H(e), x) : p;
  }, x.nodeAlign = function(e) {
    return arguments.length ? (i = typeof e == "function" ? e : H(e), x) : i;
    ...
    return arguments.length ? (m = typeof e == "function" ? e : H(e), x) : m;
  }, x.links = function(e) {
    return arguments.length ? (b = typeof e == "function" ? e : H(e), x) : b;
  ...
  arcTo: function(t, n, s, a, u) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(c * p - i * o) > D) || !u)
        ...
        var b = s - _, y = a - g, x = p * p + i * i, E = b * b + y * y, L = Math.sqrt(x), A = Math.sqrt(m), N = u * Math.tan((tt - Math.acos((x + m - E) / (2 * L * A))) / 2), P = N / A, j = N / L;
        Math.abs(P - 1) > D && (this._ += "L" + (t + P * o) + "," + (n + P * c)), this._ += "A" + u + "," + u + ",0,0," + +(c * b > o * y) + "," + (this._x1 = t + j * p) + "," + (this._y1 = n + j * i);
      }
  },
...
function Ut(t) {
  var n = Ft, s = Rt, a = Dt, u = Bt, _ = null;
  function g() {
...
var it = function() {
  var t = function(p, i, o, c) {
    ...
    parse: function(i) {
      var o = this, c = [0], m = [], b = [null], y = [], x = this.table, E = "", L = 0, A = 0, N = 2, P = 1, j = y.slice.call(arguments, 1), S = Object.create(this.lexer), M = { yy: {} };
...
const se = {
  ...
  let p;
  u === "sandbox" && (p = G("#i" + n));
  const i = u === "sandbox" ? G(p.nodes()[0].contentDocument.body) : G("body"), o = u === "sandbox" ? i.select(`[id="${n}"]`) : G(`[id="${n}"]`), c = _?.width ?? g.width, m = _?.height ?? g.width, b = _?.useMaxWidth ?? g.useMaxWidth, y = _?.nodeAlignment ?? g.nodeAlignment, x = _?.prefix ?? g.prefix, E = _?.suffix ?? g.suffix, L = _?.showValues ?? g.showValues, A = a.db.getGraph(), N = se[y], P = 10;
...
${x}${Math.round(w * 100) / 100}${E}` : d;
  ...
  O.append("path").attr("d", Xt()).attr("stroke", I).attr("stroke-width", (d) => Math.max(1, d.width)), Et(void 0, o, 0, b);
}, oe = {
  draw: re
}, le = (t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
