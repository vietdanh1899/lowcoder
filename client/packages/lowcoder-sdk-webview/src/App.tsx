...
const LowcoderAppView: any = lazy(async () => ({
  default: (await import("lowcoder-sdk")).LowcoderAppView,
}));
...
function App() {
  ...
  useEffect(() => {
    ...
    window.loadScreen = ({ appId, baseUrl, moduleInputs, appDsl, moduleDslMap }: any) => {
