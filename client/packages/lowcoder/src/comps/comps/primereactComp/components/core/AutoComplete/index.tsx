...
let AutoCompleteCompBase = (function () {
  const childrenMap = {
    viewRef: RefControl<AutoComplete>,
  ...
  return new UICompBuilder(childrenMap, (props: any) => {
    ...
    return (
      ...
      >
        <span className={classNames}>
          {props.staticProps.iconClass && (
            <i className={props.staticProps.iconClass} style={{ zIndex: 9 }}></i>
          )}
          <AutoComplete
            ref={props.viewRef}
            {...props.staticProps}
    ...
    .setExposeMethodConfigs(refMethods([focusWithOptions]))
    .build();
})();
