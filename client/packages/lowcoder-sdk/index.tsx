...
import { AppViewInstance, bootstrapAppAt, LowcoderAppView } from "lowcoder";
import { ReactDemoApp } from './src/index'

const url = new URL(location.href);
const appId = "65717e1922d9271320eea6a0";
...
function AppTest() {
  ...
  return (
    <ReactDemoApp appId={appId} baseUrl={baseUrl} input={{ id: '1' }} onEventTriggered={(output) => {
...
async function bootstrap() {
  ...
  // React
  ReactDOM.render(<AppTest />, document.querySelector("#app2"));
}
