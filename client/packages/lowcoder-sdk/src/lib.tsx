...
class WcScreenRenderer extends HTMLElement {
  ...
  #render(): void {
    ...
    if (this.appId) this.root.render(<LowcoderAppView
      ...
      onModuleEventTriggered={(e: string) => this.dispatchEvent(new CustomEvent('moduleEventTriggered', {detail: e}))}
      onModuleOutputChange={(e: unknown) => this.dispatchEvent(new CustomEvent('moduleOutputChange', {detail: e}))}
    />);
  }
